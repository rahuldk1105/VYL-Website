      ...
      <div className="bg-black/50 backdrop-blur-lg border-b border-white/10 sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          >
            ...
            <span className="font-semibold">Back to Trials</span>
          </Link>
          <div className="flex items-center gap-3">
            <img src="/veeran_logo.png" alt="Veeran" className="w-10 h-10" />
            <span className="text-gold font-black text-xl hidden sm:inline">MADRID TRIALS</span>
          </div>
        </div>
      </div>
          ...
          <AnimatePresence mode="wait">
            {isSubmitted ? (
              ...
              <motion.div
                ...
                className="bg-gradient-to-br from-gray-800 to-gray-900 border border-white/20 rounded-3xl p-12 text-center"
              >
                <motion.div
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                ...
                <motion.p
                  ...
                  className="text-gray-300 mb-8 text-lg max-w-md mx-auto"
                >
                ...
                >
                  <p className="text-gray-400">
                    ...
                    <span className="text-gold font-bold text-2xl">{redirectCountdown}</span>{' '}
                    seconds...
                  </p>

                  <button
                    onClick={() => router.push('/')}
                    className="inline-flex items-center gap-2 bg-gradient-to-r from-gold to-yellow-500 text-black font-bold px-8 py-4 rounded-full hover:shadow-[0_0_30px_rgba(255,215,0,0.4)] transition-all transform hover:scale-105"
                  >
                    Back to Home
                  </button>
                </motion.div>
              ...
              >
                ...
                <div className="text-center mb-8">
                  ...
                  <div className="mt-4 flex items-center justify-center gap-4 text-sm">
                    ...
                    <span className="text-gold font-black text-2xl">₹299</span>
                  </div>
                </div>

                {/* Form Container */}
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-white/20 rounded-3xl overflow-hidden shadow-2xl">
                  <iframe
                    src={registrationUrl}
