...
export default function DevelopmentLeagueRegistrationPage() {
    const containerId = "zf_div_DaBrfmteMH4ZBmNGrqAEKlpcNGxaGEuiSn7MyW7FmkM"
    const formUrl = "https://forms.zohopublic.in/trackmyacademy/form/VEERANDEVELOPMENTLEAGUE/formperma/DaBrfmteMH4ZBmNGrqAEKlpcNGxaGEuiSn7MyW7FmkM?zf_rszfm=1&zf_enablecamera=true"
    ...
    useEffect(() => {
        try {
            ...
            f.setAttribute("aria-label", 'Veeran Development League - Registration form')
